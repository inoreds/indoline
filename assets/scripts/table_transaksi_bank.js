var TableTransaksi_bank = function () {
    ...
    var handleTable = function () {
        ...
        var table = $('#table-transaksi_bank');
        ...
        var tableWrapper = $("#table-transaksi_bank_wrapper");
        ...
        $('#table-transaksi_bank_new').click(function (e) {
            e.preventDefault();
        ...
        $('#simpanDetailBank').click( function() { 
            
            var aiNew = oTable.fnAddData(['','', '', '','']);
            var nRow = oTable.fnGetNodes(aiNew[0]);
            var newString = new Array();
            oTable.fnUpdate($('.id_account_bukti_bank').val(), nRow, 0, false);
            oTable.fnUpdate($('.id_account_bukti_bank option:selected').text(), nRow, 1, false);
            oTable.fnUpdate($('#nominalAkun').val(), nRow, 2, false);
            oTable.fnUpdate($('#keteranganAkun').val(), nRow, 3, false);
            oTable.fnUpdate('<a class="delete" href="">Delete</a>', nRow, 4, false);
            oTable.fnDraw();
            $('#nominalAkun').val("");
            $('#keteranganAkun').val("");
            $("#akunBank").prop("disabled", true);

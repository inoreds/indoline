var TableTransaksi_penjualan = function () {
    ...
    var handleTable = function () {
        ...
        var table = $('#table-transaksi_penjualan');
        ...
        var tableWrapper = $("#table-transaksi_penjualan_wrapper");
        ...
        $('#table-transaksi_penjualan_new').click(function (e) {
            e.preventDefault();
        ...
        $('#simpanDetailPenjualan').click( function() { 
            
            var aiNew = oTable.fnAddData(['','', '', '','','','','']);
            var nRow = oTable.fnGetNodes(aiNew[0]);
            var newString = new Array();
            oTable.fnUpdate($('#tglSupplyPenjualan').val(), nRow, 0, false);
            oTable.fnUpdate($('#tglSupplyPenjualanAkhir').val(), nRow, 1, false);
            oTable.fnUpdate($('#lokasi').val(), nRow, 2, false);
            oTable.fnUpdate($('#barangPenjualanBBM').val(), nRow, 3, false);
            oTable.fnUpdate($('#jumlahPenjualan').val(), nRow, 4, false);
            oTable.fnUpdate($('#hargaPenjualan').val(), nRow, 5, false);
            oTable.fnUpdate($('#subTotalPenjualan').val(), nRow, 6, false);
            oTable.fnUpdate('<a class="delete" href="">Delete</a>', nRow, 7, false);
            oTable.fnDraw();
            $('#tglSupplyPenjualan').val("");
            $('#tglSupplyPenjualanAkhir').val("");
            $('#lokasi').val("");
            $('#barangPenjualanBBM').val("");
            $('#jumlahPenjualan').val("");
            $('#hargaPenjualan').val("");
            $('#subTotalPenjualan').val("");

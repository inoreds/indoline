...
$("#simpanPOReturPembelian").on("click", function () {
    //alert('fakyuh !!');
     if (($('#noPO').val() == "") || ($('#idVessel').val() == "") )
     { 
         $('#warningPOReturPembelian').show(50);
     }   
     else
     {
         $.post('trnReturPembelian/simpan', {
             noPo: $('#noPo').val(),
             ...
             window.location.href = 'trnReturPembelian';
             if (result == 0)
             {

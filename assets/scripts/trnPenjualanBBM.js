...
{
    window.location.href = 'trnPenjualanBBM/invoice?id='+id;
}


$("#tambahPOCustomer").on("click", function () {
    $('#status').val('tambah');
    $('.modalInput').modal('show');
});

$("#simpanPOPenjualanBBM").on("click", function () {
    if (($('#tglPO').val() == ""))
    {   
    ...
    else
    {
        ...
        $.post('trnPenjualanBBM/simpanPO', {
            ...
            window.location.href = 'trnPenjualanBBM';
            if (result == 1)
            {
...
function inputMBA_MBT(noPOCustomer, detilNumber)
{
    alert(jumlah);
...
function inputMBA(noPOCustomer, detilNumber, jumlah,idBBM)
{
    $('#noPOCustomer_MBA').val(noPOCustomer);
    $('#detilNumber_MBA').val(detilNumber);
    $('.detilNumber_jumlah').val(jumlah);
    $('#detilNumber_idBBM').val(idBBM);
    $('#status_MBA').val('tambah');
    $('.modal_MBA').modal('show');
}

function inputMBT(noPOCustomer, detilNumber)
{
...
$("#simpanMBA_MBT").on("click", function () {

        $.post('trnPenjualanBBM/simpanMBA_MBT', {
...
$("#simpanMBA").on("click", function () {

        $.post('trnPenjualanBBM/simpanMBA', {
            noPOCustomer: $('#noPOCustomer_MBA').val(),
            detilNumber: $('#detilNumber_MBA').val(),
            qty: $('#detilNumber_jumlah').val(),
            idBBM: $('#detilNumber_idBBM').val(),
...
$("#simpanMBT").on("click", function () {

        $.post('trnPenjualanBBM/simpanMBT', {
...
function editMBA(noPOCustomer, detilNumber)
{
    ...
    $.map(json, function(item) {
        ...
        $("#noPOCustomer_MBA").val(item.NoPOCustomer); 
        $("#detilNumber_MBA").val(item.DetilNumber); 
...
function getDataMBA(noPOCustomer, detilNumber)
{
  var json = (function () {
    ...
    $.ajax({
        'async': false,
        'global': false,
        'url': 'trnPenjualanBBM/getDataMBAById',
...
function deleteMBA(noPOCustomer, detilNumber, noMBA)
{
    if (confirm('Apakah anda ingin menghapusnya?')) {
        $.get('trnPenjualanBBM/hapusMBA', {
...
function printMBA(noPOCustomer, detilNumber, noMBA)
{
     window.location.href = 'trnPenjualanBBM/printOut_MBA?noPOCustomer='+noPOCustomer+'&detilNumber='+detilNumber+'&noMBA='+noMBA;

}

function editMBT(noPOCustomer, detilNumber)
{
...
function getDataMBT(noPOCustomer, detilNumber)
{
  var json = (function () {
    ...
    $.ajax({
        'async': false,
        'global': false,
        'url': 'trnPenjualanBBM/getDataMBTById',
        'data': {'noPOCustomer': noPOCustomer, 'detilNumber': detilNumber},
        'dataType': "json",
        'success': function (data) {
            json = data;
...
function printMBT(noPOCustomer, detilNumber, noMBT)
{
     window.location.href = 'trnPenjualanBBM/printOut_MBT?noPOCustomer='+noPOCustomer+'&detilNumber='+detilNumber+'&noMBT='+noMBT;

}

function cetakKwitansi2(po, detil)
{
    window.location.href = 'trnPenjualanBBM/kwitansi?po='+po+'&detil='+detil;
}

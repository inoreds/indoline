...
class CI_Pagination {
	...
	public function __construct($params = array())
	{
        ...
        $config_style['full_tag_open'] = '<div class="text-center"><ul class="pagination pagination-sm">';
        $config_style['full_tag_close'] = '</ul></div>';
        $config_style['first_link'] = FALSE;
        $config_style['last_link'] = FALSE;
        $config_style['next_link'] = 'Selanjutnya &rarr;';
        $config_style['next_tag_open'] = '<li class="="fa fa-chevron-left">';
        $config_style['next_tag_close'] = '</li>';
        $config_style['prev_link'] = '&larr; Sebelumnya';
        $config_style['prev_tag_open'] = '<li class="="fa fa-chevron-right">';

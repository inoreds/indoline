      ...
      <div class="x_panel">
        <div class="x_title">
          ...
          <div class="nav navbar-right panel_toolbox">
            <a type="button" class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>mstPBBKB/printOut">Print Out</a>
        ...
        <div class="x_content">
          <div class="table-responsive">
            <table class="table table-striped jambo_table bulk_action table-mstBahanBakar" id="datatable">
              <thead>
                <tr class="headings">
                  <th class="column-title">ID PBBKB </th>
                   ...
                   <?php
                      foreach($dataTable as $dt)
                      {
                        ...
                        <tr>
                              ...
                              <td>
                                <a type="button" class="btn btn-warning btn-xs" onclick="editDataMstPBBKB('<?php echo $dt->idPBBKB ?>')"><i class="fa fa-pencil"></i></a>
                                <a type="button" class="btn btn-dark btn-xs"  onclick="deleteDataMstPBBKB('<?php echo $dt->idPBBKB ?>')"><i class="fa fa-trash"></i></a> 
                              </td>
                        </tr>   
                        <?php   
                      }
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel">Input Data PBBKB</h4>
        </div>
          ...
          <div class="">
                    ...
                    <div class="alert alert-danger alert-dismissible" role="alert" id="warningDataMstBBM" style="display: none;">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jenis PBBKB <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="jenispbbkb" required="required" class="form-control col-md-7 col-xs-12"  maxlength="65">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nilai" required="required" class="form-control col-md-7 col-xs-12"  maxlength="255">
                        </div>
                      </div>
					  <div class="form-group">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" id="simpanDataMstPBBKB">Simpan</button>
        </div>

...
<table border="0" >
	<thead>
		<tr class="headings">
			<th class="column-title" style="width: 70%;" colspan="3"><img src="<?php echo base_url("assets/images/header.PNG"); ?>" width="100%" height="55%"/></th>
			<th class="column-title" style="width: 30%; text-align:Center">Invoice<br />
...
<div class="col-md-12 col-sm-12 col-xs-12">
	<table border="0" >
		...
		<tr>
			...
			<td>
				<div class="">
					<p>Tanggal Supply : <?php echo $getData['TglAkhirSupply'];?></h2>
				<br />
					<p>Tanggal Invoice : <?php echo $getData['TglPO'];?></h2>
				</div>
			</td>
		</tr>
		<tr>
			...
			<table border="1" cellspacing="1">
				...
				<tbody>
					...
					<tr>
                          ...
                          <td colspan="2">&nbsp;&nbsp;Pengiriman BBM <?php echo $dt->NamaBBM; ?> ke Pelanggan </td>
                          <td>&nbsp;&nbsp;Rp. <?php echo number_format($dt->SubTotal,0,".","."); ?></td>
                    </tr>   
                    <tr>
                          <td></td>
                          <td style=" border-right: solid 1px #FFF;">&nbsp;&nbsp;Tanggal</td>
                          <td>: <?php echo $dt->TglSupply; ?></td>
                          <td></td>
                    </tr>   
                    <tr>
                          <td></td>
                          <td style=" border-right: solid 1px #FFF;">&nbsp;&nbsp;Vol Bunker</td>
                          <td>: <?php echo number_format($dt->Quantity,0,".","."); ?> LITER</td>
                          <td></td>
                    </tr> 
                    <tr>
                          <td></td>
                          <td style=" border-right: solid 1px #FFF;">&nbsp;&nbsp;Harga</td>
                          <td>: &nbsp;&nbsp;Rp. <?php echo number_format($dt->Harga,0,".","."); ?> / LITER</td>
                          <td></td>
                    </tr>  
                  <?php } ?>
                    <tr>

...
<?php
	$Data 		= mysql_query("Select * from PembelianNonPertamina p, MstSupplier s, BarangBBM b, MstKapal k where k.IdVessel = p.IdVessel and p.IdSupplier = s.IdSupplier and p.IdBBM = b.IdBBM and ContactPerson='$contactPerson' ");
	...
	<div class="x_content">
		<div class="table-responsive">
			<table border="0" cellspacing="1">
				...
				<tbody>
					...
					<tr>
						...
						<td>:</td>
						<td width="50%">
							<?php echo "Rp.".$hargaPenjualan?>,-/Liter (Sudah Termasuk <b>PPN</b> dan <b>PBBKB</b>)<br/>
							<?php echo "Rp. ".number_format($HargaBeli);?>,-/Ret (Ongkos Angkut Transportir) 
						</td>
					</tr>
					<tr>
						<td width="10%">&nbsp;</td>
			...
			<table border="0" cellspacing="1">
				...
				<tbody>				
					<tr>
						<td style="text-align:center" align="center"><?php echo strtoupper($namaPerusahaan);?></td>	
						<td>&nbsp;</td>	
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>

...
class app_load_data_table extends CI_Model {
    ...
    {
	    //$get  = $this->db->query("Select * From PembelianPertamina pp, MstKapal k, MstCustomer c where pp.IdVessel = k.IdVessel and pp.IdCustomer = c.IdCustomer");
	    $get  = $this->db->query("Select * From PembelianPertamina pp, MstKapal k, BarangBBM bb, MstCustomer where pp.IdBBM = bb.IdBBM and pp.IdVessel = k.IdVessel and POPembelian='$id'");

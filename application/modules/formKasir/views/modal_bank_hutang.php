  <div class="modal fade bs-example-modal-lg modal-bank_hutang"   role="dialog" aria-hidden="true">
                        ...
                        <div class="alert alert-danger alert-dismissible" role="alert" id="warningPOPembelianPertamina" style="display: none;">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md- col-sm-8 col-xs-12">
                                 <select class="form-control id_supplier select2_single" style="width: 100%;" id="id_supplier_hutang">
                                  </select>
                              </div>
                          </div>  
                          <div class="form-group">

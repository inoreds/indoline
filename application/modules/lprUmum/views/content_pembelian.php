        ...
        <div class="" role="tabpanel" data-example-id="togglable-tabs">
          ...
          <div id="myTabContent" class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in" id="tab_pembelian" aria-labelledby="profile-tab">
              ...
              <div class="row" style="margin-bottom: 30px;margin-left: 0px;">
                     <p class="lead">Pembelian Non Agen</p>
                      <p>Menunjukkan setiap transaksi pembelian barang non agen, informasi yang ditampilkan berupa tanggal pembelian, nama barang, dan total pembelian</p>
                      <a type="button" class="btn btn-default" href="<?php echo base_url(); ?>lprUmum/pdf_pembelianNonAgen">Lihat Laporan</a>
              </div>
              <div class="row" style="margin-bottom: 30px;margin-left: 0px;">
                     <p class="lead">Retur Pembelian Barang</p>
                      <p>Menunjukkan setiap transaksi Retur pembelian barang, informasi yang ditampilkan berupa tanggal retur pembelian, retur nama barang, dan total retur pembelian</p>
                      <a type="button" class="btn btn-default" href="<?php echo base_url(); ?>lprUmum/pdf_ReturPembelian">Lihat Laporan</a>
              </div>   
            </div>  
          </div>
        </div>

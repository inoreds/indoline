        ...
        <div class="modal-body">
          <div class="">
						...
						<div class="col-md-6">
							<div class="form-group">
                              ...
                              <div class="col-md-9 col-sm-9 col-xs-12">
                                <input type="text" required="required" class="form-control col-md-7 col-xs-12" maxlength="65" id="noPOCustomer_MBA_Non" class="noPOCustomer_penjualan" readonly>
                              </div>
                            </div>
						</div>
                      </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <input type="hidden" id="detilNumber_MBA_Non" class="detilNumber_penjualan">
                    <input type="hidden" id="detilNumber_jumlah_Non" class="detilNumber_jumlah_Non">
                    <input type="hidden" id="detilNumber_idBBM_Non" class="detilNumber_idBBM">
                    <button type="button" class="btn btn-primary" id="simpanMBA_Non">Simpan</button>
                  </div>
        </div>

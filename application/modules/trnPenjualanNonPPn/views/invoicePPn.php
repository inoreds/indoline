			...
			<table border="1" cellspacing="1">
				...
				<tbody>
					...
					<tr>
                          ...
                          <td>&nbsp;&nbsp;Rp. <?php echo number_format(($dt->Harga*($dt->Quantity)),2,".","."); ?></td>
                    </tr>   
					</tr>   
                          <td></td>
                    ...
                    <tr>
                          ...
                          <td>: &nbsp;&nbsp;Rp. <?php echo number_format(($dt->Harga),2,".","."); ?> / LITER</td>
                          <td></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="center">PPN 10% &nbsp;&nbsp;&nbsp;</td>                       
                          <td>&nbsp;&nbsp;Rp. <?php echo number_format(((($dt->Harga)*($dt->Quantity))*0.1),2,".","."); ?></td>
                    </tr>
					<tr>
                        <td></td>
                        <td style=" border-right: solid 1px #FFF;"></td>
                        <td align="center">PBBKB &nbsp;&nbsp;&nbsp;</td>
                          <td>&nbsp;&nbsp;Rp. <?php echo number_format(((($dt->Harga)*($dt->Quantity))*0.05),2,".","."); ?></td>
                    </tr>
                        <td></td>
                        <td style=" border-right: solid 1px #FFF;"></td>

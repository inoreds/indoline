  <div class="modal fade bs-example-modal-lg modalInputNonPPN" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content" style="width: 1280px;  margin-left: -70px">
        ...
        <div class="modal-body">
          <div class="">
                    ...
                    <div class="alert alert-danger alert-dismissible" role="alert" id="warningPOPembelianPertamina" style="display: none;">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Tanggal PO <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md- col-sm-6 col-xs-12">
                             <select class="form-control" id="ppn" disabled="yes">  
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" id="simpanPOPenjualanNonPpn">Simpan</button>
        </div>

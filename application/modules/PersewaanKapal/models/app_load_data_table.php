...
class app_load_data_table extends CI_Model {
	...
	public function getAllData()
    {
	    ...
	    $get  = $this->db->query(" select pb.NoPoCustomer, p.tanggal, p.recieptFrom, p.paymentOf, p.jumlah from penjualanbbm pb, persewaan p where pb.NoPoCustomer = p.NoPoCustomer");
    ...
    public function getAllData_kwitansi($po)
    {
	    
	    $get  = $this->db->query("select pb.NoPoCustomer, p.tanggal, p.recieptFrom, p.paymentOf, p.jumlah from penjualanbbm pb, persewaan p where pb.NoPoCustomer = p.NoPoCustomer and pb.NoPoCustomer = '$po'");
	    return $get->row();
    }

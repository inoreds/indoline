...
class trnPenjualanBBM extends CI_Controller {
	...
	function invoice()
	{
		if($this->session->userdata("logged_in")!="")
		{
			...
			{
				$this->load->view('trnPenjualanBBM/invoicePPnOAT', $d);
			}
			else
			{

...
$Data 		= mysql_query("Select * From BarangBBM bb, penjualanbbm pb, Penjualanbbm_Detil pd where pd.IdBBM = bb.IdBBM and pd.NoPoCustomer = pb.NoPoCustomer and bb.IdBBM= '$IdBBM'");
...
<table border="0" >
	<thead>
		<tr class="headings">
			...
			<?php echo $noInvoice//$NoPO;?></small></th>
		</tr>
	</thead>
</table>
<hr class="style2">
	...
	<div class="x_content">
		<div class="table-responsive">
			<table border="1" cellspacing="1">
				...
				<tbody>
					<?php $count = 0; $total=0; $hrgtotal=0;?>
					...
					<tr>
                          ...
                          <td colspan="2">&nbsp;&nbsp;Pengiriman BBM <?php echo $dt->NamaBBM; ?> , <?PHP echo $NamaKapal; ?>, <?PHP echo $dt->lokasi; ?> </td>
                          <td>&nbsp;&nbsp;Rp. <?php
                          	if($dt->NamaBBM == "MFO"){
								$hrg = (($dt->Harga)/1.1)*($dt->Quantity);
                          		echo number_format(($hrg),2,".",".");	
                          	} else {
								$hrg = (($dt->Harga)/$wil)*($dt->Quantity);
                          		echo number_format(($hrg),2,".","."); 
                          	}
                          ?></td>
                    </tr>   
                    ...
                    <tr>
                          ...
                          <td>: &nbsp;&nbsp;Rp. <?php 
                          if($dt->NamaBBM == "MFO"){
                          		echo number_format((($dt->Harga)/1.1),2,".","."); 
                          	} else {
                          		echo number_format((($dt->Harga)/$wil),2,".",".");  
                          	}		
                          ?> / LITER</td>
                          <td></td>
                    </tr>
					
					<?php $hrgtotal = $hrgtotal + $hrg; } ?>
                    <tr>
						<tr>
                        <td></td>
                        ...
                        <td align="center">PPN 10% &nbsp;&nbsp;&nbsp;</td>                       
                          <td>&nbsp;&nbsp;Rp. <?php 
                          if($dt->NamaBBM == "MFO"){
                          		echo number_format((($hrgtotal)*0.1),2,".","."); 
                          	} else {
	                          echo number_format((($hrgtotal)*0.1),2,".","."); 
	                        }
                          ?></td>
					...
					<tr>
                        <td></td>
                        <td style=" border-right: solid 1px #FFF;"></td>
                        <td align="center">PBBKB <?php echo $dt->keterangan?>&nbsp;&nbsp;&nbsp;</td>
                          <td>&nbsp;&nbsp;Rp. <?php 
                          if($dt->NamaBBM == "MFO"){
                          		echo number_format((((($dt->Harga)/1.1)*($dt->Quantity))*0),2,".","."); 
                          	} else {
                          		echo number_format((((($dt->Harga)/$wil)*($dt->Quantity))*$pbbkb),2,".","."); 
                      		}
                          ?></td>
                    </tr>
                        <td></td>

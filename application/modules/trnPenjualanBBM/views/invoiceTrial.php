			...
			<td width = "50%">				
				<p style="border:0; line-height:1.5 ">
					<font style="font-family:Times New Roman; font-size:15px">
						Kepada Yth,
						<br/><?php echo $getDataC['NamaPerusahaan']; ?>
						<br/><?php echo $namaPelanggan; ?>
						<br/>Telp. <?php echo $getDataC['TelpCustomer1']; ?>
						<br/>Email. <?php echo $getDataC['EmailCustomer']; ?>
					</font>
				</p>
			</td>
	...
	<div class="x_content">
		<div class="table-responsive">
			<table border="0" cellspacing="1">
				...
				<tbody>
					...
					<tr>
						...
						<td>Nama Kapal:</td>
						<td>:</td>
						<td width="50%"><?php echo $getData['VesselName'];?></td>
					</tr>
					<tr>
						<td width="10%">&nbsp;</td>
						<td>Pelabuhan Pengisian Bunker </td>
						<td>:</td>
						<td width="50%"><?php echo $getData['PortSource'];?></td>
					</tr>
					<tr>
						<td width="10%">&nbsp;</td>
						<td>Tanggal Pengisian</td>
						<td>:</td>
						<td width="50%"><?php echo $getData['TglPengisian'];?></td>
					</tr>
					<tr>
						<td width="10%">&nbsp;</td>
						<td>Spesifikasi BBM</td>
						<td>:</td>
						<td width="50%"><?php echo $getData['NamaBBM'];?></td>
					<tr>
					</tr>
						<td width="10%">&nbsp;</td>
						<td>Volume Bunker</td>
						<td>:</td>
						<td width="50%"><?php echo $getData['JumlahPermintaan'];?></td>
					<tr>
					</tr>
						<td width="10%">&nbsp;</td>
						<td>Harga</td>
						<td>:</td>
						<td width="50%"><?php echo "Rp. ".$getData['HargaPenjualan'];?>,-/Liter</td>
					</tr>
					<tr>
						<td width="10%">&nbsp;</td>
						<td>Syarat Pembayaran</td>
						<td>:</td>
						<td width="50%"><?php echo "Syarat Pembayaran"//$getData['TglPO'];?></td>
					</tr>
					<tr>
						<td width="20%">&nbsp;</td>
						<td>Contact Person</td>
						<td>:</td>
						<td width="50%"><?php echo $getData['NamaCustomer']."/".$getData['NoHp'];?></td>
					</tr>
					<tr>
						<td width="100%" colspan="4">
			...
			<table border="1" cellspacing="1">
				...
				<tbody>				
					<tr>
						<td><?php echo strtoupper($getDataC['NamaPerusahaan']);?></td>	
						<td>&nbsp;</td>	
					</tr>
					<tr>
						<td colspan="2">&nbsp;</td>

      ...
      <div class="x_panel">
        <div class="x_title">
          ...
          <div class="nav navbar-right panel_toolbox">
            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" id="tambahPOCustomer">Input PO Customer</button>
          </div>
          <div class="clearfix"></div>
        </div>
        <div class="x_content">
                          ...
                          <td></td>
                            ...
                            <?php foreach($dataTablePO_detil as $dtPO_detil) { if ($dtPO_detil->NoPoCustomer == $dtPO->NoPoCustomer) {?>
                                ...
                                <tr style="background-color: #c7e8e8"; class="treegrid-<?php echo $dtPO_detil->DetilNumber; ?> treegrid-parent-<?php echo $dtPO->NoPoCustomer; ?>" >
                                    ...
                                    <th class="column-title no-link last"><span class="nobr">Invoice</span>
                                    </th>
                                    <th></th> 
                                </tr>
                                <?php } ?>
                                <tr style="background-color: #eef3de"; class="treegrid-<?php echo $dtPO_detil->DetilNumber; ?> treegrid-parent-<?php echo $dtPO->NoPoCustomer; ?>">
                                      ...
                                      <td>
                                        <?php if ($dtPO_detil->NoMBA == null) { ?>
                                          <a type="button" class="btn btn-info btn-xs" onclick="inputMBA('<?php echo $dtPO_detil->NoPoCustomer ?>','<?php echo $dtPO_detil->DetilNumber ?>',<?php echo $dtPO_detil->Quantity ?>,'<?php echo $dtPO_detil->IdBBM ?>')"><i class="fa fa-file-o"></i> MBA</a>
                                        <?php } else { ?>
                                          <div class="btn-group" style="margin-bottom: 6px;">
                                            ...
                                            <ul class="dropdown-menu">
                                              <li><a onclick="editMBA('<?php echo $dtPO_detil->NoPoCustomer ?>','<?php echo $dtPO_detil->DetilNumber ?>')">Edit MBA</a>
                                              </li>
                                              <li><a onclick="printMBA('<?php echo $dtPO_detil->NoPoCustomer ?>','<?php echo $dtPO_detil->DetilNumber ?>','<?php echo $dtPO_detil->NoMBA ?>')">Print MBA</a>
                                              </li>
                                              <li><a onclick="deleteMBA('<?php echo $dtPO_detil->NoPoCustomer ?>','<?php echo $dtPO_detil->DetilNumber ?>','<?php echo $dtPO_detil->NoMBA ?>')">Delete MBA</a>
                                              </li>
                                            </ul>
                                          </div>
                                        <?php } ?>
                                         <?php if ($dtPO_detil->NoMBT == null) { ?>
                                          <a type="button" class="btn btn-warning btn-xs" onclick="inputMBT('<?php echo $dtPO_detil->NoPoCustomer ?>','<?php echo $dtPO_detil->DetilNumber ?>')"><i class="fa fa-file-o"></i> OAT</a>
                                        <?php } else { ?>
                                          <div class="btn-group" style="margin-bottom: 6px;">
                                            ...
                                            <ul class="dropdown-menu">
                                              <li><a onclick="editMBT('<?php echo $dtPO_detil->NoPoCustomer ?>','<?php echo $dtPO_detil->DetilNumber ?>')">Edit OAT</a>
                                              </li>
                                              <li><a onclick="printMBT('<?php echo $dtPO_detil->NoPoCustomer ?>','<?php echo $dtPO_detil->DetilNumber ?>','<?php echo $dtPO_detil->NoMBT ?>')">Print OAT</a>
                                              </li>
